...
export const ATOM_CONFIGS: Record<AtomType, AtomData> = {
  ...
  'Carbon': {
    ...
    neutrons: 6,
    electrons: [
      { radius: 1.5, speed: 3.6 },
      { radius: 1.5, speed: -3.6 },
      { radius: 3.2, speed: 2.2 },
      { radius: 3.2, speed: -2.2 },
      { radius: 3.2, speed: 1.8 },
      { radius: 3.2, speed: -1.8 },
      { radius: 1.5, speed: 3.6 },
      { radius: 1.5, speed: -3.6 },
      { radius: 3.2, speed: 2.2 },
  ...
  'Oxygen': {
    ...
    neutrons: 8,
    electrons: [
      { radius: 1.5, speed: 4.0 },
      { radius: 1.5, speed: -4.0 },
      { radius: 3.5, speed: 2.8 },
      { radius: 3.5, speed: -2.8 },
      { radius: 3.5, speed: 2.4 },
      { radius: 3.5, speed: -2.4 },
      { radius: 3.5, speed: 2.0 },
      { radius: 3.5, speed: -2.0 },
      { radius: 1.5, speed: 4.0 },
      { radius: 1.5, speed: -4.0 },
      { radius: 3.5, speed: 2.8 },
